...
C     Amplitude(s) for diagram number 54
      ...
      CALL FFS5_2(W(1,1),W(1,15),GC_105,MDL_MC,ZERO,W(1,10))
C     Amplitude(s) for diagram number 55
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,19),GC_81,GC_77,AMP(55))
      CALL FFV2_3_2(W(1,1),W(1,19),GC_81,GC_77,MDL_MC,ZERO,W(1,10))
C     Amplitude(s) for diagram number 56
      CALL FFS5_0(W(1,10),W(1,2),W(1,15),GC_105,AMP(56))
...
C     Amplitude(s) for diagram number 64
      ...
      CALL FFS5_2(W(1,1),W(1,12),GC_105,MDL_MC,ZERO,W(1,10))
C     Amplitude(s) for diagram number 65
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,25),GC_81,GC_77,AMP(65))
      CALL FFV2_3_2(W(1,1),W(1,25),GC_81,GC_77,MDL_MC,ZERO,W(1,10))
C     Amplitude(s) for diagram number 66
      CALL FFS5_0(W(1,10),W(1,2),W(1,12),GC_105,AMP(66))
...
C     Amplitude(s) for diagram number 69
      CALL FFS5_0(W(1,24),W(1,2),W(1,16),GC_105,AMP(69))
      CALL FFS5_2(W(1,1),W(1,16),GC_105,MDL_MC,ZERO,W(1,12))
